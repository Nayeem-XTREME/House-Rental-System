...
<body>
        ...
        <div class="container" id="Hi">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav navbar-right" id="Hello">
                    <li role="presentation" class="log"><a href="Register.php">sign up</a></li>
                </ul>
    ...
    <div id="main1" class="main2">
        <div class="row register-form">
            <div class="col-md-8 col-md-offset-2">
                <form class="form-horizontal custom-form" id="login" action="Login.php" method="POST" enctype="multipart/form-data">
