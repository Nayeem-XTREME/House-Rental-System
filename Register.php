<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	  ...
	  if ($pas == $cpas) {
	    ...
	    $query = "INSERT INTO USERS (Name, Email, Password) VALUES ('$name', '$mail', '$hashpass')";
        ...
        <div class="container" id="Hi">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav navbar-right" id="Hello">
                    <li role="presentation" class="log"><a href="Login.php">Login </a></li>
                </ul>
    ...
    <div id="main2">
        <div class="row register-form">
            <div class="col-md-8 col-md-offset-2">
                <form class="form-horizontal custom-form" id="register" action="Register.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="col-sm-4 label-column">
                            <label class="control-label" for="dropdown-input-field">Sex </label>
                        </div>
                        <div class="col-lg-offset-0 col-sm-6 input-column">
                            <div class="dropdown">
                                <button class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false" type="button">Male <span class="caret"></span></button>
                    ...
                    <button class="btn btn-default submit-button" type="submit" name="register">SUBMIT</button>
                </form>
            </div>
        </div>
    </div>
